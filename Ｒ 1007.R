rm(list = ls()) #清除變數
install.packages("DescTools") #安裝處理工具 #日期處理
install.packages("ggplot2") #繪圖
install.packages("lubridate") #日期處理
...
ggtitle(paste("Based on", Month_hours, "hours this month Goal of 10,000 hours will be reached on\n"
