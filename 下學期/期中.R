...
dir()
COVID_19=read.csv("owl_world_TW.csv", fileEncoding = "UTF-8-BOM")
COVID_19_vac=read.csv("owl_world_TW_vac.csv", fileEncoding = "UTF-8-BOM")#下載疫苗覆蓋率
# View(COVID_19)
...
View(COVID_19_part)
COVID_19_part_2022<-subset(COVID_19_part,date<="2022-05-18 CST"
                           &date>="2022-01-01 CST")
...
ggplot()+
  ...
  annotate("text" #標籤
           ...
           ,label=paste(COVID_19_part_2022$date[which.max(COVID_19_part_2022$daily_vaccination_avg)]
                        ...
                        ,"%")
           ,colour="black",size=3,vjust=-2, hjust=1)+
  ...
  ggtitle(paste("Taiwan 2022 COVDI-19 "
